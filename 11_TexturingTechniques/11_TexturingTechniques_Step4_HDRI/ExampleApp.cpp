...
void ExampleApp::UpdateGUI() {
    ...
    if (ImGui::TreeNode("Image Processing")) {

        ImGui::SliderFloat("Expose",
                           &m_meshGroupGround.m_basicPixelConstantData.expose,
                           0.0f, 10.0f);

        ImGui::SliderFloat("Gamma",
                           &m_meshGroupGround.m_basicPixelConstantData.gamma,
                           0.1f, 5.0f);
