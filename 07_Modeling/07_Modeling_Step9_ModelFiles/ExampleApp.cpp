...
bool ExampleApp::Initialize() {
    ...
    //auto meshes =
    //    GeometryGenerator::ReadFromFile("C:/DEVELOPMENT/GIT/DX11_HongLab/models/glTF-Sample-Models-master/2.0/", "benz.fbx");

    // GLTF 샘플 모델들
    // https://github.com/KhronosGroup/glTF-Sample-Models

     auto meshes = GeometryGenerator::ReadFromFile(
         "C:/DEVELOPMENT/GIT/DX11_HongLab/models/glTF-Sample-Models-master/2.0/FlightHelmet/glTF/",
         "FlightHelmet.gltf");
