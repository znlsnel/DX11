...
hlab::TessellationModel::TessellationModel(ComPtr<ID3D11Device> &device,
    ...
    CraeteTextureArray(Ground37);
    CraeteTextureArray(Ground64);
    CraeteTextureArray(PavingStones070);
    CraeteTextureArray(Rock030);
    ...
    if (m_isVisible) {
        for (const auto &mesh : m_meshes) {
            ...
            vector<ID3D11ShaderResourceView *> resViews = {
                ...
                m_aoTexturesSRV.Get(), m_textureMapSRV.Get()};
